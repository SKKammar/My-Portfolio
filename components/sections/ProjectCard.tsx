  ...
  return (
    <Card className="p-6 flex flex-col gap-4">
      ...
      <div className="flex gap-4 mt-2">
        {project.liveUrl && (
          <a href={project.liveUrl} className="font-sans text-xs text-paper underline underline-offset-4">
            Live
          </a>
        )}
        {project.githubUrl && (
          <a href={project.githubUrl} className="font-sans text-xs text-paper underline underline-offset-4">
            Code
          </a>
        )}
      </div>
