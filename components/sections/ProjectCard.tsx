...
export function ProjectCard({
    ...
    return (
        <Card
            onClick={onClick}
            className={`group flex flex-col p-4 md:p-8 transition-all duration-100 ease-out hover:-translate-y-1 hover:border-white/20 hover:shadow-lg ${onClick ? 'cursor-pointer' : ''}`}
        >
