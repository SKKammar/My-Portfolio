...
export function AdminForm({ onClose }: { onClose: () => void }) {
    ...
    const handleSubmit = async () => {
        ...
        const body = {
            ...form,
            id: form.title.toLowerCase().replace(/\s+/g, '-'), // simple slug from title
            ...
            <div className="bg-ink-card border border-ink-border p-6 w-full max-w-md max-h-[90vh] overflow-y-auto">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <input
                        ...
                        placeholder="Technologies, comma separated (e.g. React, Node, Postgres)"
                        className="p-2 bg-ink border border-ink-border text-paper font-sans text-sm"
                    />
                    <input
                        value={form.liveUrl}
                ...
                <div className="flex gap-2 mt-4">
                    <button
                        ...
                        className="flex-1 border border-ink-border py-2 font-sans text-xs"
                    >
